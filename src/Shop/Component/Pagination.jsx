...
function Pagination(props) {
    ...
    const { pagination, handlerChangePage, totalPage, length } = props
    ...
    return (
        <nav aria-label="Page navigation example" className="pt-5">
            ...
            <div className="pagination justify-content-center justify-content-lg-end">
                <p className="text-small text-muted mb-0">Showing {(page-1)*count+1}–{page*count>length?length:page*count} of {length} results</p>
            </div>
        </nav>
    );
}
